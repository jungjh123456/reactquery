...
`;
export default function RecipeReviewCard({ loading }) {
    ...
    <DivWrap>
      <Card sx={{ maxWidth: "100%" }}>
        <CardHeader
          ...
          title={loading ? <Skeleton animation="wave" height={10} width="80%" style={{ marginBottom: 6 }} /> : "Shrimp and Chorizo Paella"}
